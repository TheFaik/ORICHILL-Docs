...
#### `👾` Добро Пожаловать на <mark style="color:$primary;">**документацию**</mark> сервера <mark style="color:$primary;">**ORICHILL**</mark>! 🍺💕 <a href="#connecting" id="connecting"></a>

<mark style="color:$primary;">**`↳`**</mark> Здесь вы узнаете все особенности, правила и необходимую для вас информацию. **Приятного чтения**! 🤗

## <mark style="color:$primary;">**Как подключится?**</mark> <a href="#connecting" id="connecting"></a>
...
{% hint style="info" icon="google-drive" %}
<mark style="color:blue;">`→`</mark> Для нашего сервера мы реализовали свой персональный клиент для комфортной игры.\
Он добавляет визуальные улучшения, из-за чего вы действительно сможете насладиться ми на нашем уютном сервере. \
\
Также, клиент основан на мод-паке [**Fabulously Optimized**](https://modrinth.com/modpack/fabulously-optimized), который очень хорошо оптимизирует сам клиент, потому вы можете не опасаться того, что ваш пк не сможет потянуть клиент. \
\
...
* **Эндер Мир** - _<mark style="color:$primary;">**`20000`**</mark> бл._ от нулей в каждую сторону.

## <mark style="color:$primary;">**Авто-рестарт сервера**</mark> <a href="#restarts" id="restarts"></a>
...
* <mark style="background-color:yellow;">**`Магазин`**</mark> - [**\*КЛИК**](https://store.orichill.ru/) (_**👈 жмяк)**_
* <mark style="background-color:blue;">**`VK-Группа`**</mark> - [**\*КЛИК**](https://vk.com/orichill) (_**👈 жмяк)**_
* <mark style="background-color:purple;">**`Сервер Discord`**</mark> - [**\*КЛИК**](https://discord.orichill.ru/) (_**👈 жмяк)**_
* <mark style="background-color:$success;">**`Онлайн-Карта`**</mark> - [**\*КЛИК**](https://map.orichill.ru/) (_**👈 жмяк)**_
* <mark style="background-color:$primary;">**`Telegram-канал`**</mark> - [**\*КЛИК**](https://t.me/orichill) (_**👈 жмяк)**_

## <mark style="color:$primary;">**Контентмейкеры сервера**</mark>&#x20;

<details>

<summary><mark style="background-color:red;">YouTube Каналы</mark></summary>

* TheFaikli - [**\*КЛИК**](https://www.youtube.com/channel/UCaH6r-m2S-1jGxlypgHt3ig) (_**👈 жмяк)**_

</details>

<details>

<summary><mark style="background-color:purple;"><strong>Twitch Каналы</strong></mark></summary>

* TheFaikli - [**\*КЛИК**](https://www.twitch.tv/thefaikli) (_**👈 жмяк)**_

</details>

<details>

<summary><mark style="background-color:yellow;"><strong>TikTok Каналы</strong></mark></summary>

* TheFaikli - [**\*КЛИК**](https://www.tiktok.com/@thefaikli) (_**👈 жмяк)**_

</details>

\
&#x20;<mark style="background-color:$primary;">Актуальность на</mark> <mark style="background-color:$primary;"></mark><mark style="background-color:$primary;">**16.04.2026**</mark> \
Проект входит в [**\[MSN\] "QXORY NETWORK"**](https://www.qxorynet.ru/).

[^1]: IP-Адрес сервера ORICHILL.\
    \
    С помощью него, вы сможете подключиться и играть на нём.
