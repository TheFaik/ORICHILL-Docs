...
```bash
yarn add @algolia/ingestion@1.52.1
# or
npm install @algolia/ingestion@1.52.1
# or
pnpm add @algolia/ingestion@1.52.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/ingestion@1.52.1/dist/builds/browser.umd.js"></script>
```
