...
```bash
yarn add @algolia/client-query-suggestions@5.52.1
# or
npm install @algolia/client-query-suggestions@5.52.1
# or
pnpm add @algolia/client-query-suggestions@5.52.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-query-suggestions@5.52.1/dist/builds/browser.umd.js"></script>
```
