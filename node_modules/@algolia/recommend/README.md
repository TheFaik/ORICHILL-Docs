...
```bash
yarn add @algolia/recommend@5.52.1
# or
npm install @algolia/recommend@5.52.1
# or
pnpm add @algolia/recommend@5.52.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/recommend@5.52.1/dist/builds/browser.umd.js"></script>
```
