...
```bash
yarn add @algolia/monitoring@1.52.1
# or
npm install @algolia/monitoring@1.52.1
# or
pnpm add @algolia/monitoring@1.52.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/monitoring@1.52.1/dist/builds/browser.umd.js"></script>
```
